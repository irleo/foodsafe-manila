    ...
    switch (type) {
      case ReportSheetType.waterQualityIssue:
        return _ReportSheetData(
          ...
          infoText:
              'Early reporting helps authorities identify outbreaks and prevent more people from getting sick.',
        );
      ...
      case ReportSheetType.unsafeSystemOrEstablishment:
        return _ReportSheetData(
          ...
          infoText:
              'When in doubt, you can still submit a report. Health authorities can assess the information you provide, and early reporting can prevent an outbreak before it starts.',
        );
